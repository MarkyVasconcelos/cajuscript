...
public class CajuScriptEngine implements ScriptEngine, Invocable {
	 ...
	 * from functions.
	 */
	public static final String CAJU_VARS_FUNC_RETURN = CajuScript.CAJU_VARS
			.concat("_func_return_");

	/**
	 * Prefix of the variables created automaticaly to defined the values for
	 * parameters of functions.
	 */
	public static final String CAJU_VARS_FUNC_PARAM = CajuScript.CAJU_VARS
			.concat("_func_param_");
	...
	public Object invokeFunction(String name, Object... args)
			throws ScriptException, NoSuchMethodException {
		String cmd = "";
		String funcReturnName = CAJU_VARS_FUNC_RETURN.concat(caju
				.nextVarsCounter());
...
class InterfaceImplementor {
	...
	public Object getInterface(Object thiz, Class<?> iface)
		...
		if (iface == null || !iface.isInterface()) {
			...
			return iface.cast(java.lang.reflect.Proxy.newProxyInstance(iface
